...
export const COUNTRY_TZ: Record<string, string> = {
  ...
  GW:"Africa/Bissau",     GY:"America/Guyana",      HN:"America/Tegucigalpa",
  HK:"Asia/Hong_Kong",    HR:"Europe/Zagreb",       HT:"America/Port-au-Prince",
  ...
  KM:"Indian/Comoro",     KP:"Asia/Pyongyang",      KR:"Asia/Seoul",
  KW:"Asia/Kuwait",       KZ:"Asia/Almaty",         LA:"Asia/Vientiane",
  LB:"Asia/Beirut",       LI:"Europe/Vaduz",        LK:"Asia/Colombo",
  ...
  ML:"Africa/Bamako",     MM:"Asia/Rangoon",        MN:"Asia/Ulaanbaatar",
  MO:"Asia/Macau",        MR:"Africa/Nouakchott",   MT:"Europe/Malta",
  ...
  VU:"Pacific/Efate",     WS:"Pacific/Apia",        XK:"Europe/Belgrade",
...
export function resolveCountryCode(person: {
  ...
  const raw = (person.locationCountry ?? person.location ?? "").trim().toLowerCase();
  if (!raw) return null;
